...
For this version of SunPy we have started building our `conda <http://conda.pydata.org/docs/>`_ packages on the excellent `conda forge <http://conda-forge.github.io>`_ service.
This means you need to add the conda-forge channel to your conda installation.
If you have never installed SunPy before we recommend you follow our `installation instruction <http://docs.sunpy.org/en/stable/installation>`_.
