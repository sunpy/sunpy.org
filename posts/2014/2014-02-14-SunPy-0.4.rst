...
who participated in GSOC 2013. It includes the addition of a new local database for storing and searching data, it features a HEK to VSO translator and a new HELIO module in net.
As well as this major work has been undertaken on the documentation and a new website developed.

To download the latest SunPy release go to our `website <http://sunpy.org>`_ or download from `PyPI <https://pypi.python.org/pypi/sunpy>`_ . The documentation for the latest release can now be found at `docs.sunpy.org <http://docs.sunpy.org/en/stable/http://docs.sunpy.org/en/stable/>`_
