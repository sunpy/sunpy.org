...
[To be balanced, the CEO of Anaconda, Peter Wang posted this message on Linkedin.](https://www.linkedin.com/posts/pzwang_hi-everyone-recently-there-has-been-discussion-activity-7229549723462905856-rQH-/)
He says that:
...
Hopefully by the end of the year which these changes in place, users have a clearer idea of if they are allowed to use Anaconda.
...
[A blog post written by Tim de Jager & Ruben Artssummarizes how conda-forge is free and avoids any vendor lock in.](https://prefix.dev/blog/towards_a_vendor_lock_in_free_conda_experience)
